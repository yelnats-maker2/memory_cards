...
class Mpuzzle_state:
    ...
    def getRandomizedBoard():
        ...
        z = a list: [(shape, color), revealed] where revealed is a bool"""
        icons = []
    ...
    def __init__(self):
        ...
        self.mode = Mpuzzle_state.MODE_START
        self.tries = 0
        self.maxtries = 20
    ...
    def selectBox(self, boxx, boxy):
        ...
        Returns True if a selection was added or False if they were both full beforehand.
        """
        ...
        # selection 1 has something, put it in selection 2:
            ...
            #if they don't match and they're not the same square then increment self.tries
